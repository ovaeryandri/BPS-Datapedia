            ...
            <div class="mb-6 link-container">
                <table class="w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        @foreach ($maklumat as $index => $item)
                            ...
                            <td class="p-3 border border-gray-200">
                                ...
                                <td class="p-3 border border-gray-200">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('maklumat.edit', $item->id) }}" class="px-3 py-1 bg-blue-300 hover:bg-blue-400 text-blue-800 rounded">Edit</a>

                           <form action="{{ route('maklumat.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
